...
get_menu() {
 ...
 case "$clean_answer" in
  ...
  "7")
   ...
   ;;
  "8")
   echo -e "${green}Выделены порты 50000-50099,1400,3478-3481,5349 и расскоменитированы стратегии DS, WA, TG в строках 168 и 169 конфига.${plain}"
