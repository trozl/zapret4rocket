 ...
 case "$clean_answer" in
  ...
  "8")
	if grep -q '^NFQWS_PORTS_UDP=443$' "/opt/zapret/config"; then
     ...
     sed -i 's/^NFQWS_PORTS_UDP=443$/NFQWS_PORTS_UDP=443,1400,3478-3481,5349,50000-50099/' "$CONFIG"
     ...
     sed -i 's/^NFQWS_PORTS_UDP=443,1400,3478-3481,5349,50000-50099$/NFQWS_PORTS_UDP=443/' "$CONFIG"
     sed -i '168,169s/^/--skip /' "$CONFIG"
